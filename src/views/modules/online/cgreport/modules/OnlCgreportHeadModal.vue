          ...
          columns: [
            {
              ...
              defaultValue: '',
              placeholder: '请输入字段名',
              validateRules: [{ required: true, message: '字段名不能为空' }]
            },
            {
              title: '排序',
              width: '7%',
              ...
              defaultValue: 0,
              placeholder: '排序',
              validateRules: [{ required: true, message: '排序' }]
            },
            {
              title: '字段文本',
              width: '13%',
              ...
              placeholder: '请输入字段文本',
              defaultValue: '',
              validateRules: [{ required: true, message: '字段文本不能为空' }]
            },
            {
              title: '类型',
              width: '13%',
              ...
              defaultValue: 'String',
              placeholder: '请选择类型',
              validateRules: [{ required: true, message: '类型不能为空' }]
            },
            {
              title: '是否显示',
              width: '3%',
          ...
          columns: [
            {
              ...
              defaultValue: '',
              placeholder: '请输入参数',
              validateRules: [{ required: true, message: '参数不能为空' }]
            },
            {
              width: '23%',
              title: '参数文本',
              ...
              defaultValue: '',
              placeholder: '请输入参数文本',
              validateRules: [{ required: true, message: '参数文本不能为空' }]
            },
            {
              width: '23%',
              title: '默认值',
            ...
            },
            {
              ...
              defaultValue: 0,
              placeholder: '排序',
              validateRules: [{ required: true, message: '排序不能为空' }]
            }
          ],
          dataSource: []
        }
