  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          amendmentUrl: '/busiInsurance/tbusinessinsurance/policyNoAndFee', //修改保单号
        }
      }
    },
    methods: {
      edit(record) {
        ...
        this.$nextTick(() => {
          this.form.setFieldsValue(pick({buyPay:this.model.buyPay,policyNo:this.model.policyNo,invoiceNo:this.model.invoiceNo,}, 'buyPay', 'policyNo','invoiceNo'))
        })
      },
      onSelect(val){
      ...
      handleOk() {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            const httpurl = _this.url.amendmentUrl
            values.id = _this.model.id
            httpAction(httpurl, values, 'PUT').then((res) => {
