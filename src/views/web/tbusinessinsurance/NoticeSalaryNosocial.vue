  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button
        type="primary"
        icon="download"
        v-has="'wxhr:thavesalarynosocail_export'"
        @click="exportHandle"
      >导出</a-button>
    </div>
    ...
    <div>
      ...
      >
        ...
        >
          <a v-if="String(records.createUserId) === String(logedUserId)" @click="handleFeedback(records)">反馈</a>
          <span v-else>{{ '-' }}</span>
        </span>
      </a-table>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/hrBase/thavesalarynosocial/page',
        exportXlsUrl: '/hrBase/thavesalarynosocial/export',
        exportFields: '/hrBase/thavesalarynosocial/getExportFieldName',
        ignorance: '/hrBase/thavesalarynosocial/ignore',
        feedback: '/hrBase/tfeedback/feedback', // 反馈
      }
    }
  },
  created() {
  ...
  methods: {
    ...
    exportHandle: function() {
      this.$refs.DispatchApplyExportModalForm.title = '有工资无社保导出'
