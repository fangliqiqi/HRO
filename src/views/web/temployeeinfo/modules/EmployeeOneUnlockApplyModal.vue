...
<script>
  ...
  export default {
    name: 'EmployeeOneUnlockApplyModal',
    components: {
      ErrorModal,
    },
    data() {
      return {
        ...
        url: {
          add: 'hrBase/temployeeinfo/unLockApplyByEmpIds',
        },
      }
    },
    methods: {
      ...
      handleOk() {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            httpurl += `?ids=${this.ids}&reason=${formData.reason}&nextUserId=${formData.nextUserId}`
