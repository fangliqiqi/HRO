...
<script>
  ...
  export default {
    name: 'EmployeeDelegateUnlockingAuditModal',
    data() {
      return {
        id: '', // 委派派单id
        model: {},
        ...
        url: {
          add: 'hrBase/tunlockapplyinfo/unLockAuditDelegate',
        },
      }
    },
    methods: {
      ...
      handleOk() {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            httpurl += `?id=${that.id}&nextUserId=${formData.nextUserId}&remark=${formData.remark}`
