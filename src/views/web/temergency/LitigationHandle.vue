      ...
      >
        ...
        >
          ...
          <a
            ...
            v-has="'wxhr:tLitigationEvent_handle'"
            v-if="userInfo.id == record.handleMan"
          >办理</a>
        </span>
      </a-table>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/hrEmergency/tlitigationevent/auditOrHandle/page?selectType=1',
    ...
    methods: {
      ...
      handleLitigation(record){
        this.modalTitle = '诉讼事件_诉讼办理'
        //获取记录
        httpAction(this.url.getRecordUrl+'?id='+record.id+'&payMainType=0&type=4',null,'get').then((res)=>{
          if(res.code == 200){
            this.$refs.InsuranceClaimForm.url.endInjury = '/hrEmergency/tlitigationevent/end/'
            this.$refs.InsuranceClaimForm.url.deadlineUrl = '/hrEmergency/tlitigationevent/lastInsuranceMaterialSubDate'
            this.$refs.InsuranceClaimForm.edit(record,res.data,0,4)
          }else{
