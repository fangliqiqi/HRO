  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/hrEmergency/tcomplaintevent/auditOrHandle/page',
    ...
    methods: {
      ...
      handleAudit: function(record) {
        this.$refs.modalForm.title = '监察投诉事件_审核'
        ...
        this.$refs.modalForm.auditPass = 'wxhr:tComplaintEvent_audit_pass'
        this.$refs.modalForm.auditExtra = 'wxhr:tComplaintEvent_to_supplemented'
        this.$refs.modalForm.auditBack = 'wxhr:tComplaintEvent_audit_pass'
        ...
        this.$refs.modalForm.url.extraUrl = '/hrEmergency/tcomplaintevent/toSupplemented'
        this.$refs.modalForm.url.backUrl = '/hrEmergency/tcomplaintevent/back'
        this.$refs.modalForm.url.accessUrl = '/hrEmergency/tcomplaintevent/auditPass'
