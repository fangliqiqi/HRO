    ...
    <div>
      ...
      >
        ...
        >
          ...
          <a-divider
            type="vertical"
            v-has="'wxhr:tLitigationEvent_edit'"
          ...
          <a-divider
            type="vertical"
            v-has="'wxhr:tLitigationEvent_batch_commit'"
          ...
          <a-divider
            type="vertical"
            v-has="'wxhr:tLitigationEvent_del'"
            v-if="record.auditStatus == 0 || record.auditStatus == 3"
          />
          <a-popconfirm
            title="确定删除吗?"
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/hrEmergency/tlitigationevent/page',
          delete:'/hrEmergency/tlitigationevent/',
          queryAllInfoById: '/hrEmergency/tlitigationevent/vo/',
          getinfo: '/hrBase/temployeeinfo/', //根据员工ID查询员工信息
          getCustomerById: '/hrBase/tcustomerinfo/getCusNameAndBusinessType', //查询客户单位
          againCommit:'/hrEmergency/tlitigationevent/commitAgain/', //再次提交
    ...
    methods: {
      ...
      // 新建
      handleAdd: function() {
        this.$refs.modalForm.title = '诉讼申报'
        this.$refs.modalForm.url.getEmpInsurance = '/hrEmergency/tlitigationevent/insertInfo/'
        this.$refs.modalForm.url.submitApplyUrl = '/hrEmergency/tlitigationevent'
        this.$refs.modalForm.url.empValidator = '/hrEmergency/tlitigationevent/event/'
      ...
      handleDetail(record){
        this.$refs.AbitrationAuditModalForm.title = '诉讼事件_详情'
        this.$refs.AbitrationAuditModalForm.url.getDetailById = '/hrEmergency/tlitigationevent/'
        this.$refs.AbitrationAuditModalForm.flag = 4
        ...
        this.$refs.AbitrationAuditModalForm.tabTitle = '诉讼事件'
        this.$refs.AbitrationAuditModalForm.url.getHistory = '/hrEmergency/tlitigationevent/old/'
        this.$refs.AbitrationAuditModalForm.url.getEmpInsurance = '/hrEmergency/tlitigationevent/insertInfo/'
        this.$refs.AbitrationAuditModalForm.type = null
        httpAction(this.url.queryAllInfoById+record.id,null,'get').then((result) => {
          if(result.code == 200){
            if(record.workInjuryId){ //工伤事件
              ...
              this.$refs.AbitrationAuditModalForm.type = 5
            }
            //结算主体名称
      ...
      handleEdit: function(record) {
        this.$refs.modalForm.title = '诉讼事件_编辑'
        if(record.auditStatus == 2){
          this.$refs.InjuryAttachModalForm.flag = 4
              ...
              httpAction(_this.url.getinfo+record.empId,null,'get').then((result) => {
                if(result.code == 200){
                  ...
                  httpAction(this.url.getCustomerById+'?cusId='+result.data.belongUnit+'&settleDomainId='+result.data.settleDomain,null,'get').then((results) => {
                    ...
                    this.$refs.AbitrationApplyEditModalForm.flag = 4
                    this.$refs.AbitrationApplyEditModalForm.settleDomainOptions = this.settleDomainOptions
                    this.$refs.AbitrationApplyEditModalForm.url.submitApplyUrl = '/hrEmergency/tlitigationevent'
                    res.data.abitrationEvent = res.data.litigationEvent
                    delete res.data.litigationEvent
      ...
      handleSubmit: function(record) {
        ...
        if(record.auditStatus == 2){
          ...
          this.$refs.AbitrationSubmitModalForm.permissionStr = 'wxhr:tLitigationEvent_handle'
          this.$refs.AbitrationSubmitModalForm.url.submitUrl = '/hrEmergency/tlitigationevent/batch/commit'
