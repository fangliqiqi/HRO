  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/hrEmergency/tretiredworkevent/auditOrHandle/page',
    ...
    methods: {
      ...
      handleAudit: function(record) {
        this.$refs.modalForm.title = '退工事件_审核'
        ...
        this.$refs.modalForm.isOperate = true
        ...
        httpAction(this.url.getDetailById+record.id,null,'get').then((res) => {
          if(res.code == 200){
