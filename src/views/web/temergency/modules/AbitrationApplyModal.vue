        ...
        >
          ...
          >
            ...
            <a-row>
              ...
              <a-col
                :span="16"
                v-if="insuranceInfo.employeeContractInfo"
              >
                <a-form-item
                  label="已有劳动合同"
                  class="stepFormlabel"
                ...
                <a-col :span="8">
                  ...
                  >
                    <a-input
                      ...
                      v-decorator="['eventOccurrenceAddr',{rules: [{ required: true, message: '请输入劳动保障行政部门!' },{max:50,message:'劳动保障部门最多50个字符!'}] }]"
                    />
                  </a-form-item>
                </a-col>
                <a-col :span="16">
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          // customRender: text => {
          //   return (Object.keys(this.settleDomainOptions).length && this.settleDomainOptions[text]) ? this.settleDomainOptions[text]['departName'] : ''
          // }
        },
        {
          title: '手机号',
      ...
      url: {
        ...
        empValidator:'/hrEmergency/tabitrationevent/event/',
  ...
  methods: {
    ...
    handleOk() {
      ...
      let formData = Object.assign(this.model, this.allModel, {
        insuranceStatus: this.insuranceInfo.insuranceStatus == undefined ? 1 : this.insuranceInfo.insuranceStatus,
      ...
      let params = {}
      params.insurance = this.insuranceInfo.insuranceForWorkInjuryVo
      if(this.flag == 3){
        params.abitrationEvent = formData
      }else if(this.flag == 4){
        params.litigationEvent = formData
      }else if(this.flag == 5){
        params.complaintEvent = formData
      }
          ...
          if(result.data){
            ...
            httpAction(`${this.url.getCustomerById}?cusId=${this.rowEmpoyee.belongUnit}&settleDomainId=${this.rowEmpoyee.settleDomain}`,null,'get').then(res1 => {
              if(res1.code === 200){
                ...
                let param = this.rowEmpoyee.id+'?type=1&empIdcard='+this.rowEmpoyee.empIdcard+'&settleDepartId='+this.rowEmpoyee.settleDomain
