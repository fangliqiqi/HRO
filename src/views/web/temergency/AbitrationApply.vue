      ...
      >
        ...
        >
          <a
            ...
            v-has="'wxhr:tabitrationevent_detail'"
          >详情</a>
          <a-divider
            type="vertical"
            v-has="'wxhr:tAbitrationEvent_edit'"
          ...
          <a-divider
            type="vertical"
            v-has="'wxhr:tAbitrationEvent_batch_commit'"
          ...
          <a-divider
            type="vertical"
            v-has="'wxhr:tAbitrationEvent_del'"
            v-if="record.auditStatus == 0 || record.auditStatus == 3"
          />
          <a-popconfirm
            title="确定删除吗?"
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/hrEmergency/tabitrationevent/page',
          delete:'/hrEmergency/tabitrationevent/',
          ...
          againCommit:'/hrEmergency/tabitrationevent/commitAgain/', //再次提交
    ...
    methods: {
      ...
      // 新建
      handleAdd: function() {
        this.$refs.modalForm.title = '仲裁申报'
      ...
      handleDetail(record){
        this.$refs.AbitrationAuditModalForm.title = '仲裁事件_详情'
      ...
      handleEdit: function(record) {
        this.$refs.modalForm.title = '仲裁事件_编辑'
        if(record.auditStatus == 2){
          this.$refs.InjuryAttachModalForm.flag = 3
              ...
              httpAction(_this.url.getinfo+record.empId,null,'get').then((result) => {
                if(result.code == 200 && result.data){
                  ...
                  httpAction(this.url.getCustomerById+'?cusId='+result.data.belongUnit+'&settleDomainId='+result.data.settleDomain,null,'get').then((results) => {
                    ...
                    this.$refs.AbitrationApplyEditModalForm.businessTypeDicts = this.businessTypeDicts
      ...
      handleSubmit: function(record) {
        ...
        if(record.auditStatus == 2){
          ...
          this.$refs.AbitrationSubmitModalForm.permissionStr = 'wxhr:abitration_handle'
          this.$refs.AbitrationSubmitModalForm.url.submitUrl = '/hrEmergency/tabitrationevent/batch/commit'
