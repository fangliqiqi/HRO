...
<script>
  ...
  export default {
    name: 'FinancialBillsAuditList',//财务账单审核-财务审核
    ...
    data() {
      return {
        ...
        url: {
          list: 'hrSocial/tfinancebill/getTFinanceBillSecondAudit', // 列表
          exportUrl:'hrSocial/tfinancebill/getTFinanceBillSecondAuditList' //导出
