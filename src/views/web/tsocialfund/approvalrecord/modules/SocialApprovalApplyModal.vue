  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {
          organId: { rules: [{ required: true, message: '请选择社保户！' }] },
          createMonth: { rules: [{ required: true, message: '请选择生成月份！' }] },
        },
        url: {
          add: 'hrSocial/tsocialaprovalform/saveSocialAproval',
        },
      }
    },
    methods: {
      ...
      handleOk() {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            httpurl += `?organId=${formData.organId}&createMonth=${formData.createMonth}&haveContain=${formData.haveContain}`
