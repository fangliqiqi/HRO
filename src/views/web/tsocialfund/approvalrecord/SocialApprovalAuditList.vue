      ...
      >
        ...
        >
          ...
          <a-divider
            ...
            v-has="'wxhr:tsocialaprovalform_audit'"
          />
          <a
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: 'hrSocial/tsocialaprovalform/page?status=5',
    ...
    methods: {
      ...
      handleEdit: function(record) {
        ...
        this.$refs.socialApprovalApplyDetailModal.title = '社保核准表审核'
        this.$refs.socialApprovalApplyDetailModal.isAudit = true
