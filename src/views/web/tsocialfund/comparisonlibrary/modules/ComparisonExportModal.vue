  ...
  export default {
    ...
    methods: {
      ...
      handleOk() {
        ...
        let reqData = {}
        const httpurl = this.url.exportXlsUrl
        const formData = Object.assign(this.computedCheckedFields)
        reqData.idStr = this.idStr
        reqData.comparisonLibrary = this.requestParams
        reqData.exportFields = formData

        downFilePost(httpurl, reqData).then((res) => {
          if (res.size > 0) {
