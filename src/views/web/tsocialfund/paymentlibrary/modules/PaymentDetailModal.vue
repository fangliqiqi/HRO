            ...
            <a-row>
              ...
              <a-col :span="12">
                ...
                >
                  ...
                  <span v-else>{{ model.departName }}</span>
                </a-form-item>
              </a-col>
            </a-row>
          </a-card>
  ...
  export default {
    ...
    methods: {
      ...
      edit(record) {
        ...
        if (this.editButton) {
          this.getSettleDomainList(this.model.unitId)
          if (this.socialShow) {
            // yhy优化
            ...
            this.model.personalBigmailmentMoney = this.model.personalBigmailmentMoney?this.model.personalBigmailmentMoney:0
            console.log(this.model.personalBigmailmentMoney);
            this.$nextTick(() => {
      ...
      handleOk() {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            requestData.settleDomainId = formData.settleDomainId
      ...
      // 根据单位id获取结算主体列表
      getSettleDomainList(id) {
        const httpurl = `hrBase/tsettledomain/selectDomainByUnitId?id=${id}`
