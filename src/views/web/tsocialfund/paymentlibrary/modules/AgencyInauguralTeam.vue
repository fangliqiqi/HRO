        ...
        <a-row>
          <a-col :span="24">
            <a-form-item
              ...
              class="stepFormText"
            >
              <a-input v-decorator="['inauguralTeam', validatorRules.inauguralTeam]"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
    ...
    data() {
      return {
        ...
        validatorRules: {
          ...
          inauguralTeam: {rules: [{ required: true, message: '请输入班组' }]},
        },
        url: {
          add: 'hrSocial/tagent/doCreate',
          exportUrl: 'hrSocial/tagent/doExportByInauguralTeam'
        },
        errData: [],
      }
    },
