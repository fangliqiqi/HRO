<template>
  <a-card :title="settlementhFormInfo.settleDepartNo">
    ...
    <a-card :bordered="false">
      <div class="tabDiv">
        <h2 id="tabledesc1">{{ salaryStandardInfo.settleDepartName }}{{ salaryStandardInfo.settleMonth }} - 结算单</h2>
        <table class="table1" aria-describedby="tabledesc1">
          <tr class="tr1">
            ...
            <td
              class="td1"
              colspan="2"
            >{{ salaryStandardInfo.settleDepartName }}</td>
          ...
          <tr class="tr1">
            ...
            <td
              class="td1"
              :colspan="salaryStandardInfo.noBusinessType==1?4:2"
            >{{ salaryStandardInfo.settleDepartNo }}</td>
            <td class="tit td1" v-if="salaryStandardInfo.noBusinessType!=1">结算时间</td>
            <td
              v-if="salaryStandardInfo.noBusinessType!=1"
              class="td1"
              colspan="2"
            >{{ salaryStandardInfo.settleMonth }}</td>
          </tr>
          <tr class="tr1" v-if="salaryStandardInfo.noBusinessType==1">
          ...
          <template v-if="settlementhFormInfo.eventFlag != null">
            <tr class="tr1">
    ...
    >
      <a-table
        ...
        :dataSource="poorBalanceInfoList"
        :pagination="false"
      >
      </a-table>
    </a-card>
  ...
  methods:{
    ...
    show(){
      ...
      if(this.settleDeail.eventFlag != null){
        const emergencyType = this.settleDeail.payMainType
        const res = this.emergencyType.find(item=>item.value === emergencyType)
        this.emergencyTypeName = res ? res.label : '-'
        this.showPay = /GS/i.test(this.settleDeail.eventCode) ? true : false
      }
