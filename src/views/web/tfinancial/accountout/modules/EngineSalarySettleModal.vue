      ...
      <div class="tabDiv">
        ...
        <table class="table1" aria-describedby="tabledesc1">
          <tr class="tr1">
            ...
            <td class="td1">{{ salaryStandardInfo.settleDepartName }}</td>
  ...
  methods:{
    ...
    async show() {
      ...
      this.settleDeail = this.settlementhFormInfo
        // 业务类型
      this.salaryStandardInfo.businessType = await getBusinessType(this.settlementhFormInfo.settleDepartId)
