  ...
  methods:{
    ...
    show(){
      ...
      for(var d in this.employData){
        ...
        //   this.revenueName = d.nickname
        // }
        if(this.coverList[0].createUser == d){
      ...
      for(var c in this.panes){
        ...
        let bankName = filterDictText(this.bankOptions, this.panes[c].bankName)
        if(bankName == '-' && this.panes[c].bankName){
          // eslint-disable-next-line
        }else{
          this.panes[c].bankName = bankName
        }
      }
    },
    onChange(activeKey ){
