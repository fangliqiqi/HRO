        ...
        columns: [
          {
            ...
            validateRules: [
              {
                required: true, // 必填
                message: "请输入字段名称" // 显示的文本
              },
              {
                pattern: /^[a-z|A-Z][a-z|A-Z\d_-]{0,}$/, // 正则
                message: "字段名称必须以字母开头，可包含数字、下划线、横杠"
              }
            ]
          },
          {
            ...
            defaultValue: '',
            placeholder: "请输入字段备注",
            validateRules: [{ required: true, message: "请输入字段备注" }]
          },
          {
            title: '字段类型',
            key: 'dbFieldType',
            ...
            defaultValue: '',
            placeholder: "请选择字段类型",
            validateRules: [{ required: true, message: "请选择字段类型" }]
          },
          {
            title: '字段长度',
            key: 'dbLength',
            ...
            defaultValue: 32,
            placeholder: "字段长度",
            validateRules: [{ required: true, message: "请输入字段长度" }]
          },
          {
            title: '默认值',
            key: 'dbDefaultVal',
            ...
            defaultValue: '',
            placeholder: "请输入默认值",
            validateRules: [{ required: true, message: "请输入默认值" }]
          },
          {
            title: '可以为空',
            key: 'isNull',
