<template>
  <a-card :title="settlementhFormInfo.settleDepartNo">
      ...
      <div class="tabDiv">
        ...
        <table class="table1" aria-describedby="tabledesc1">
          ...
          <tr class="tr1">
            ...
            <td class="td1">{{ settlementhFormInfo.noSalaryPersonSocialTicket ?
              settlementhFormInfo.noSalaryPersonSocialTicket.toFixed(2) : settlementhFormInfo.noSalaryPersonSocialTicket }}</td>
          </tr>
          <tr class="tr1">
            <td
              class="tit td1"
    ...
    <income-belong-modal ref="IncomeBelongForm" :amoutInfo="settleDeail"></income-belong-modal>
  </a-card>
</template>
<script>
import { getAction } from '@/api/manage'
import { getItemName } from '@/utils/common'
import IncomeBelongModal from '@/views/salarystandard/modules/IncomeBelongModal'

export default {
  name: 'AuditSettleAccountModal',
  components: {
    IncomeBelongModal
  },
  data() {
  ...
  methods:{
    getItemName,
    incomeSplit(){
      this.$refs.IncomeBelongForm.isEdit = false;
