      ...
      >
        ...
        >
          <a
            ...
            v-has="'wxhr:tsalarystandard_doAudit'"
          >审核</a>
          <!-- <a-divider type="vertical" />
          <a
            @click="handleAppoint(record.id)"
            v-has="'wxhr:auditinfo_assign_check'"
          >委派审核</a> -->
        </span>
...
<script>
  ...
  import AuditInfoModal from './modules/AuditInfoModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        selectedRows: [],
        url: {
          list: '/salary/tsalarystandard/auditSalaryStandardPage?type=0&status=1',
