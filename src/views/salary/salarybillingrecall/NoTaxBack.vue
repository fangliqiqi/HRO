<template>
  <a-card :bordered="false">
    ...
    <div>
      ...
      >
        ...
        >
          <a
            type="primary"
            v-has="'wxhr:tsalarystandard_notax_goBack'"
    ...
    <audit-info-modal
      ...
      @ok="modalFormOk"
    ></audit-info-modal>
    <search-detail-modal ref="modalDetail" @ok="modalFormOk"></search-detail-modal>
  </a-card>
</template>
...
<script>
  ...
  import SearchDetailModal from '../nopersonaltax/modules/NoPersonTaxSearchDetail'
  ...
  export default {
    ...
    data () {
      return {
        ...
        settlementList:[],
        url: {
          list: '/salary/tsalarystandard/gobackSalaryStandardPage?type=1',
