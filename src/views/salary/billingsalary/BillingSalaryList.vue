      ...
      >
        ...
        >
          <a
            ...
            v-has="'wxhr:tsalarystandard_doBilling'"
...
<script>
  ...
  import BillingSalaryModal from './modules/BillingSalaryModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: '/salary/tsalarystandard/billingSalaryStandardPage?type=0&isBacked=0',
          ...
          backUrl:'/salary/tsalarystandard/doBilling',//退回
        }
      }
    },
    created () {
