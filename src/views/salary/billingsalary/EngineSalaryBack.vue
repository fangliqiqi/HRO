      ...
      >
        ...
        >
          <a 
            ...
            @click="handleSumbit(record)">出账</a>
          <a
...
<script>
  ...
  import EngineSalaryModal from './modules/EngineSalaryModal'
  import BillingSalaryBackModal from './modules/BillingSalaryBackModal'
  import { getAction,httpAction } from '@/api/manage'
  import { initDictOptions,filterDictText } from '@/components/dict/JDictSelectUtil'
  import { getSettlementAuthorityByUser } from '@/api/api'

  export default {
    name: "EngineSalaryBack",
    components: {
      EngineSalaryModal,
    ...
    data () {
      return {
        ...
        url: {
          list: '/salary/tsalaryengineering/billingSalaryEngineeringPage?isBacked=1',
          ...
          openBill:'salary/engineer/openBill', // 详情
    ...
    methods: {
      ...
      handleIdProvinceChange(value) {
        ...
        delete this.queryParam.idAreaTowns
      },
      // 根据id获取城市数据
      ...
      handleSumbit(record) {
        ...
        httpAction(url,{},'POST').then((res) => {
          if(Number(res.code) === 200){
            this.$refs.engineModal.title = '发放出账'
            this.$refs.engineModal.settlementList = this.settlementList
            this.$refs.engineModal.employData = this.employData
            this.$refs.engineModal.show(record,res.data || {})
          }else {
