        ...
        >
          ...
          <table class="table1" aria-describedby="tabledesc1">
            <tr class="tr1">
              ...
              <th class="td1" scope="col">{{ subject_salary.departNo }}</th>
            </tr>
            <tr class="tr1">
              <td
                class="td1"
...
export default {
  ...
  data () {
    ...
    return {
      ...
      validatorRules: {
        ...
        bankNo: { rules: [{ required: true, message: '请填写银行卡号!没有输入空字符串' }] },
  ...
  methods: {
    show(coverList){
      ...
      this.panes = coverList
      this.subject_salary = this.subject
