...
export default {
  name: 'SalaryEngineSearchDetailModal',
  components: {
      ...
      httpAction(url,{},'POST').then((res) => {
        if(Number(res.code) === 200){
          ...
          let settelData = [
            ...
            {'index':'结算编码:','data':settleForm.settleDepartNo,'project':'','money':'结算编码','account':settleForm.settleMonth},
