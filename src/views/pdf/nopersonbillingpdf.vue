      ...
      <div :style="styleBox">
        ...
        >
          ...
          <p
            ...
            v-if="pane.payType == 0"
          >现金付款审批单</p>
          <p style="text-align:center;line-height:0"> <span style="margin-left: 306px;">{{ pane.createDate }}</span> <span style="margin-left: 20px;">结算主体编码 {{ pane.settleNo }}</span> </p>
          <table class="table1">
            <tr class="tr1">
              <td
                class="td1"
                colspan="2"
              >{{ sign }} 非扣税 - {{ isBackedType[salaryStandardInfo.isBacked] }}</td>
              <td
                class="td1"
                colspan="2"
              >{{ pane.createDate }}</td>
    ...
    <a-row>
      <div class="main-article">
        <div class="node-article-content">
          <p id="tabledesc1" style="text-align:center;color:red">{{ salaryStandardInfo.settlementMonth }}客户结算单</p>
          <table
            class="table1"
          ...
          >
            <tr>
              ...
              <th class="font18" scope="col">皖信盖章:</th>
              <td></td>
            </tr>
            <tr>
          ...
          >
            <tr class="tr1">
              <th
                ...
                colspan="2"
              >费用项目</th>
              <th class="tit td1" scope="col">金额</th>
              <th class="tit td1" scope="col">增值税</th>
              <th class="tit td1" scope="col">开票额小计</th>
            </tr>
            <!-- <tr class="tr1">
              <td
                class="tit td1"
          ...
          >
            <tr class="tr1">
              <th class="tit td1" scope="col">月份</th>
              <th class="tit td1" scope="col">姓名</th>
              <th class="tit td1" scope="col">项目</th>
              <th class="tit td1" scope="col">金额</th>
              <th class="tit td1" scope="col">原因</th>
            </tr>
            <tr
              class="tr1"
          ...
          >
            <tr class="tr1">
              <th class="tit td1" scope="col">姓名</th>
              <th class="tit td1" scope="col">身份证号</th>
              <th class="tit td1" scope="col">银行账号</th>
              <th class="tit td1" scope="col">实发工资合计</th>
              <th class="tit td1" scope="col">银行</th>
              <th class="tit td1" scope="col">支行</th>
            </tr>
            <tr
              class="tr1"
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="theadTr" scope="col">客户合同</th>
                    <td
                      align="left"
                      colspan="2"
                      style="padding-left: 10px;"
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      let url = this.url.doExportUrl + '?salaryFormId=' + this.id
      httpAction(url,{},'POST').then((res) => {
        if(Number(res.code) === 200){
          ...
          // 自定义数据列表
          this.pauseDiyInfoList = res.data.settlementhFormSubList != null ? res.data.settlementhFormSubList : []
          // 差额数据列表
          ...
          if(res.data.salary.advanceMoney > 0){
            let advanceUrl = this.url.getAdvance + '?formId=' + this.settlementhFormInfo.id +'&type=0'
          ...
          let receiveUrl = this.url.getReceive + '?matchId=' + this.salaryStandardInfo.id + '&type=0'
