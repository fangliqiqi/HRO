...
export default {
  ...
  methods: {
    loadData(){
      this.loading = true
      const url = `${this.url.openTInvoice}?salaryId=${this.model.id}&settleFormType=${this.settleFormType}`
    ...
    handleOk(){
      this.$refs.modalOpenChange.settleFormType = this.settleFormType // 工程工资查看开票信息
