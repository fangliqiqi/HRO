...
function sheet_from_array_of_arrays(data, opts) {
  ...
  if (opts == 1) {
    ...
    ws['!merges'].push({ s: { r: less + addNum + 11, c: 1 }, e: { r: less + addNum + 11, c: 5 } })
    ws['!merges'].push({ s: { r: less + addNum + 12, c: 1 }, e: { r: less + addNum + 12, c: 5 } })

    // ws['!merges'].push({ s: { r: less + addNum + 13, c: 1 }, e: { r: less + addNum + 13, c: 5 } })
    // ws['!merges'].push({ s: { r: less + addNum + 14, c: 1 }, e: { r: less + addNum + 14, c: 5 } })
    ...
    ws['!merges'].push({ s: { r: less + addNum + 14, c: 4 }, e: { r: less + addNum + 14, c: 5 } })
    let less2 = data[data.length - 1][1]

    if (less2 > 0) {
      for (let i = 1; i <= less2; i++) {
        ws['!merges'].push({ s: { r: less + addNum + 14 + i, c: 4 }, e: { r: less + addNum + 14 + i, c: 5 } })
      }
    }
    for (var m = 0; m < 6; m++) {
      ...
      // ws[order + (less + addNum + 13)].s = style0
      // ws[order + (less + addNum + 14)].s = style0
      
      ws[order + '5'].s = style15
    }
    for (let i = (addNum + 1); i <= (12 + less + addNum + 1); i++) {
      if (ws["B" + i] != undefined) {
        ws["B" + i].s = style17
      }
    }
